...
const TransformationForm = ({ action, data = null, userId, type, creditBalance, config = null }: TransformationFormProps) => {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    console.log("Before Submitting", image, values, data, action)
  ...
  const onTransformHandler = async () => {
    ...
    console.log("newTransformation", newTransformation, "transformationConfig", transformationConfig)
              ...
              <CustomField
                ...
                render={({ field }) => (
                  <Input
                    value={field.value}
                    className='input-field'
                    onChange={(e) => onInputChangeHandler('recolor', e.target.value, type, field.onChange)}
                  />
                )}
              />
            )}
